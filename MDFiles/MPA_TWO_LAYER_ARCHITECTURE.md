# MPA Two-Layer Architecture: Information Maximization + Failure Mode Mitigation

## 핵심 아이디어

MPA는 **2-Layer 계층 구조**로 설계되었습니다:
...
- MPA achieves Pareto optimality (best efficiency-accuracy trade-off)
...
effects. MPA achieves 246× speedup over brute-force (2029 vs 499500 pairs)
...
MPA의 핵심은 **계층적 분리(hierarchical separation)**:
